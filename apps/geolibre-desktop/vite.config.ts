...
import type { LoggingFunction, RollupLog, WarningHandlerWithDefault } from "rollup";
...
const BUILD_ENV_KEYS = [
  ...
  "VITE_LOGIN_SERVICE_URL",
  "VITE_MAPBOX_ACCESS_TOKEN",
  "VITE_MAPILLARY_ACCESS_TOKEN",
  "VITE_MICROZONATION_DOCUMENTS_LAYER",
  "VITE_MICROZONATION_OUTPUT_FORMAT",
  "VITE_MICROZONATION_PLANS_URL",
  "VITE_MICROZONATION_PROJECTS_LAYER",
  "VITE_MICROZONATION_TYPENAME",
  "VITE_MICROZONATION_URL",
