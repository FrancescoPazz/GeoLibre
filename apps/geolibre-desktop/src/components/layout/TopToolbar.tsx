...
export function TopToolbar({
  ...
  useEffect(() => {
    ...
    setTerriaCatalogLabels({
      title: t("terriaCatalog.title"),
      hint: t("terriaCatalog.hint"),
      urlPlaceholder: t("terriaCatalog.urlPlaceholder"),
      load: t("terriaCatalog.load"),
      loading: t("terriaCatalog.loading"),
      loadError: (url) => t("terriaCatalog.loadError", { url }),
      noCatalog: t("terriaCatalog.noCatalog"),
      ...
      added: (name) => t("terriaCatalog.added", { name }),
      removed: (name) => t("terriaCatalog.removed", { name }),
      addError: (name) => t("terriaCatalog.addError", { name }),
      expand: t("terriaCatalog.expand"),
      collapse: t("terriaCatalog.collapse"),
      removeSource: t("terriaCatalog.removeSource"),
      home: t("terriaCatalog.home"),
    });
    setArcGisHubLabels({
