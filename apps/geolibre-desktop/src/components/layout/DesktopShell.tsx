...
import { Rer3dToolPanels } from "../panels/Rer3dToolPanels";
...
import { useRer3dTools } from "../../hooks/desktop-shell/useRer3dTools";
...
export function DesktopShell({
  ...
  useRer3dTools(mapControllerRef);
    ...
    >
      ...
      <div data-workspace-row="" className="relative flex min-h-0 flex-1 flex-col md:flex-row">
        ...
        >
          ...
          <Rer3dToolPanels mapControllerRef={mapControllerRef} />
