...
analysis, spatial SQL, cartography, and a project file — then packages the _same_
...
| **Browser**               | Full app, nothing to install                               | No official browser build                | No                                        | Yes (the product _is_ the browser app)      | Yes                                                                                                                | Yes (the authoring product)                                                    | Yes                                |
...
that happens to ship a globe. The two overlap at the moment of _looking_ at the
...
- **Google Earth** (the web app, plus the Android and iOS apps) is the one Google
  ...
  **Professional** and **Professional Advanced** are paid per seat. Standard
  ...
  design quotas and cloud import storage, and more of the Gemini-powered _Ask
  Google Earth_, which every plan includes at a limited, higher, or highest level
  of access.
...
_Google Earth Engine_ is a third, unrelated product — a cloud platform for
...
**Choose Felt when** collaborative, low-friction map _making_ with a team is the
